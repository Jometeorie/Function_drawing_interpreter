...
public interface DrawGraphListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DrawGraphParser#dotSizeStatement}.
	 * @param ctx the parse tree
	 */
	void enterDotSizeStatement(DrawGraphParser.DotSizeStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link DrawGraphParser#dotSizeStatement}.
	 * @param ctx the parse tree
	 */
	void exitDotSizeStatement(DrawGraphParser.DotSizeStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link DrawGraphParser#styleStatement}.
	 * @param ctx the parse tree
	 */
	void enterStyleStatement(DrawGraphParser.StyleStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link DrawGraphParser#styleStatement}.
	 * @param ctx the parse tree
	 */
	void exitStyleStatement(DrawGraphParser.StyleStatementContext ctx);
	/**
